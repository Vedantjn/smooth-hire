          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-2xl font-bold text-gray-900 dark:text-white">SmoothHire</span>
              </div>
              <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                ...
                <Link href="/about" className="border-transparent text-gray-500 dark:text-gray-300 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                  About
                </Link>
              </div>
            </div>
